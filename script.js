function carregaDicionario() {
    let textAlert = "Pronte para conhecer mulheres incríveis?";
    let mulheres = [
        "Marielle Franco",
        "Lélia Gonzalez",
        "Angela Davis",
    ...
    bios.sort(function (x, y) {
        return x.nome == y.nome ? 0 : x.nome > y.nome ? 1 : -1;
    })

    for(let bio in bios) {
        /* let result = bio += " Nome: " + bios[bio].nome + ", Minibio: " + bios[bio].descrição + " Citação: " + bios[bio].citação;
        console.log(result); */
